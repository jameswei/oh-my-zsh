...
PROMPT='%{$FG[011]%}$ZSH_THEME_MATERIAL_PREFIX%{$fg_bold[cyan]%}%p %{$FG[006]%}%~%B$(git_prompt_info) %{$FG[009]%}$ZSH_THEME_MATERIAL_SUFFIX%{$FG[011]%}$ZSH_THEME_MATERIAL_SUFFIX%{$FG[010]%}$ZSH_THEME_MATERIAL_SUFFIX%b %{$reset_color%}'
